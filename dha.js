...
petik = '```'
enter = '\n'
dataff = 'User ID-Item-Nick'
dataml = 'User ID-Server-Item-Nick'
...
//------------------< Fun >-------------------
    case 'public':
       ...
       case 'bucin'
             ...
             const bcn = bucin[Math.floor(Math.random() * bucin.length)]
             buffer = await getBuffer(`https://i.ibb.co/cgtxQmQ/20211013-162714.jpg`)
             dha.sendMessage(from, buffer, image, { quoted: mek, caption: "*Bucin*\n\n"+ bcn })
             break
       case 'truth':
